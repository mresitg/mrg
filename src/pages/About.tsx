  ...
  return (
    <section className="min-h-screen pt-20 md:pt-32 pb-20 relative z-10 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-6 md:p-8 mb-6 md:mb-12 shadow-2xl opacity-0 animate-slide-up animate-delay-100">
          <div className="flex flex-col md:flex-row items-start gap-4 mb-6">
            <Briefcase className="text-cyan-400 mt-1 flex-shrink-0" size={24} />
            <div className="w-full">
              <h3 className="text-xl md:text-2xl font-bold mb-4">professional bio</h3>
        ...
        <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl opacity-0 animate-slide-up animate-delay-200">
          <div className="flex flex-col md:flex-row items-start gap-4 mb-6">
            <Code className="text-cyan-400 mt-1 flex-shrink-0" size={24} />
            <div className="w-full">
              <h3 className="text-xl md:text-2xl font-bold mb-6">key skills & expertise</h3>
