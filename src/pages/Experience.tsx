    ...
    <section className="min-h-screen pt-32 pb-20 relative z-10">
      <div className="max-w-4xl mx-auto px-8">
        ...
        <div className="space-y-6">
          <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/5 transition-all opacity-0 animate-slide-up animate-delay-100">
          ...
          <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/5 transition-all opacity-0 animate-slide-up animate-delay-200">
            <h3 className="text-2xl font-bold mb-2">AI Automation Projects</h3>
          ...
          <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/5 transition-all opacity-0 animate-slide-up animate-delay-300">
          ...
          <div className="backdrop-blur-md bg-white/3 border border-white/10 rounded-3xl p-8 shadow-2xl hover:bg-white/5 transition-all opacity-0 animate-slide-up animate-delay-400">
            <h3 className="text-2xl font-bold mb-2">Neuroscience Research</h3>
