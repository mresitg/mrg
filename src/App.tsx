function AppContent() {
  ...
  const activeSection =
    Object.keys(navigationPaths).find(
  ...
  return (
    <div
      className="text-white relative overflow-x-hidden flex flex-col"
    ...
    >
      ...
      {/* SAYFA İÇERİĞİ */}
      <div key={location.pathname} className="animate-fadeIn flex-grow pt-24 md:pt-32">
        <Routes>
          <Route path="/" element={<Home />} />
          <Route path="/about" element={<About />} />        {/* <-- düzeltildi */}
          <Route path="/experience" element={<Experience />} />
          <Route path="/contact" element={<Contact />} />
        </Routes>
      </div>

      {/* FOOTER: sticky olsun diye mt-auto, absolute değil */}
      <footer className="py-8 mt-auto text-center text-gray-500 text-sm z-10">
